...
<body>
     ...
     <div class="content">
        <img class="image" src="photos/weather.jpg" alt="">

        <div class="wrapper">
        <div class="card">
            <div class="row1">
                <form method="post">
                <input class="city" type="text" name="city" placeholder="London">
                <label for="submit"><i class="fa-solid fa-arrow-right-to-bracket"></i></label>
                <input class="btn" id="submit" name="submit" type="submit" value="view">
                </form>
